  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Dashboard</li>
          ...
          <form action="{{ route('addmissionNotice.add') }}" method="POST" enctype="multipart/form-data" class="mt-5" >
              @csrf
...
<!-- <script>
        ClassicEditor
            .create(document.querySelector('#editor'), {
                ckfinder: {
                    uploadUrl: '{{ route('addmissionNotice.add') }}' // Specify the route for file uploads
                }
            })
            .then(editor => {
